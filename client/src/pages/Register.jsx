...
function Register({ setIsAuth }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-blue-100 animate-gradient-x px-4 sm:px-6 py-8 my-8">
      <div className="w-full max-w-md sm:max-w-sm rounded-xl shadow-lg backdrop-blur-sm bg-opacity-80 px-6 sm:px-8 py-10 sm:py-12 ">
        <div className="text-center mb-2">
          <h1 className="text-2xl sm:text-3xl font-bold text-blue-600 mb-2">Create Account</h1>
          <p className="text-sm sm:text-base text-gray-600">Join us to start collaborating</p>
        </div>
